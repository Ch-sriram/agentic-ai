...
def process_topic(topic: str) -> tuple[str, str, str]:
  ...
  p2 = (
    "Write a catchy title of EXACTLY five words this summary. "
...
if __name__ == "__main__":
  print("🧠 Multi-Step Agent ready! Type a topic to start. Type 'quit' / 'exit' to stop.\n")
  while True:
    try:
